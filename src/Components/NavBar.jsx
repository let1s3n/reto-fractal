...
const NavBar = () => {
  return (
    <Navbar className="bg-secondary h-100 d-block" collapseOnSelect expand="lg">
      <Navbar.Brand className="d-block me-0 me-sm-1 p-4" href="#home"><img className="mw-100" src={logo} alt="Foxbel logo" /></Navbar.Brand>
        ...
        <Nav className="flex-column mr-auto text-white my-3 ps-3 ps-sm-5">
